...
public class AdminmaintainsMenproductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productRe= FirebaseDatabase.getInstance().getReference().child("Mens Products").child(productID);
    ...
    private void deleteThisProduct() {
        productRe.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Intent intent=new Intent(AdminmaintainsMenproductActivity.this,AdminMenCategoryDisplay.class);
                startActivity(intent);
                finish();

                Toast.makeText(AdminmaintainsMenproductActivity.this,"The product is deleted successfully",Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        else
        {
            ...
            productRe.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(AdminmaintainsMenproductActivity.this,"Changes applied successfully",Toast.LENGTH_SHORT).show();
