...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent intent=new Intent(HomeActivity.this,MenCategoryDisplay.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_women)
        {
            Intent intent=new Intent(HomeActivity.this,Womencategorydisplay.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_kids)
        {
            Intent intent=new Intent(HomeActivity.this,kidsCategoryDisplay.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_accessory)
        {
            Intent intent=new Intent(HomeActivity.this,AccessoryCategoryDisplay.class);
            startActivity(intent);
        }
