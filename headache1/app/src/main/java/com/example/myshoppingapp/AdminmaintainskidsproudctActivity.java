...
public class AdminmaintainskidsproudctActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productRe= FirebaseDatabase.getInstance().getReference().child("Kids Products").child(productID);
    ...
    private void deleteThisProduct() {
        productRe.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Intent intent=new Intent(AdminmaintainskidsproudctActivity.this,AdminKidsCategoryDisplay.class);
                startActivity(intent);
                finish();

                Toast.makeText(AdminmaintainskidsproudctActivity.this,"The product is deleted successfully",Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        else
        {
            ...
            productRe.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(AdminmaintainskidsproudctActivity.this,"Changes applied successfully",Toast.LENGTH_SHORT).show();
